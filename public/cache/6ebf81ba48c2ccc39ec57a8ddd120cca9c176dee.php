...
<!--produtos mais vendidos-->
    ...
    <section id="producto1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro">
                <img src="<?php echo DIRIMG.'img/products/tel-1-apple.png' ?>" alt="">
                <div class="des">
                    <span>APPLE</span>
                    <h5>Iphone 13</h5>
                    <div class="star">
            ...
            <!--produto 2 -->
            <div class="pro">
                <img src="<?php echo DIRIMG.'img/products/tel-1-samsung.png' ?>" alt="">
                <div class="des">
                    <span>SAMSUNG</span>
                    <h5>Samsung</h5>
                    <div class="star">
            ...
            <!--produto 3 -->
            <div class="pro">
                <img src="<?php echo DIRIMG.'img/products/tel-2-samsung.png' ?>" alt="">
                <div class="des">
                    <span>SAMSUNG</span>
                    <h5>Samsung</h5>
                    <div class="star">
            ...
            <!--produto 4 -->
            <div class="pro">
                <img src="<?php echo DIRIMG.'img/products/acessorio-1.png' ?>" alt="">
                <div class="des">
                    <span>ACESSORIO</span>
                    <h5>SmartWatch</h5>
                    <div class="star">
    ...
    <section id="funcionalidade" class="section-p1">
        <div class="func-box">
            <img src="<?php echo DIRIMG.'img/features/f1.png' ?>" alt="">
            <h6>Pagamenos online</h6>
        </div>
        <div class="func-box">
            <img src="<?php echo DIRIMG.'img/features/f2.png' ?>" alt="">
            <h6>Entregas</h6>
        </div>
        
        <div class="func-box">
            <img src="<?php echo DIRIMG.'img/features/f5.png' ?>" alt="">
            <h6>Compras rápidas</h6>
        </div>
        <div class="func-box">
            <img src="<?php echo DIRIMG.'img/features/f6.png' ?>" alt="">
            <h6>Suporte 24h/7d</h6>
        </div>
    </section>
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('user.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blade\app\views/user/index.blade.php ENDPATH**/ ?>