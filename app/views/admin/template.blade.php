...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{DIRBSCSS.'/bootstrap.min.css'}}" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
